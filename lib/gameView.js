...
(function() {
  ...
  //   // debugger;
  //   this.game = null;
  //   // this.ctx.clearRect(0, 0, document.body.clientWidth,
  ...
  GameView.prototype.printWelcomeMessage = function(){
    ...
    virusImage.onload = function(){
      this.ctx.drawImage(virusImage, width / 2 - 325, height / 2, 200, 200);
      this.ctx.fillText("Virus", width / 2 - 225, height / 2 + 100);
    }.bind(this);
    playerImage.onload = function(){
      this.ctx.drawImage(playerImage, width / 2 + 150, height / 2, 100, 100);
      this.ctx.fillText("You", width / 2 + 200, height / 2 + 50);
    }.bind(this);
