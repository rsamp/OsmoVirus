...
(function() {
  ...
  Game.prototype.remove = function (object) {
    if (object instanceof Osmos.PlayerCell) {
      ...
      this.gameOver = true;
      this.endGame("lost");
      // window.Osmos.GameView.prototype.gameOver("lost");
      ...
      this.gameOver = true;
      this.endGame("won");
      // window.Osmos.GameView.prototype.gameOver("won");
  ...
  Game.prototype.endGame = function(state){
    // Osmos.GameView.prototype.gameOver = true;
    ...
    this.ctx.fillText("You " + state + ". Press 'Space' to try again!",
